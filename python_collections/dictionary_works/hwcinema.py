...
# 2.runtime greater than 150

# run_time_filter=[m.get("title") for m in movies if int(m.get("runtime"))>150 ]
# print(run_time_filter)

# 3.highest_runtime

# highest_runtime_movie=max(movies,key=lambda d:int(d.get("runtime")))
...
# 5.max_count in which year
# value_key=[(v,k) for k,v in year_count.items()]
# print(max(value_key))

# 6.fetching movies with id
...
# 7. print drama_comedy movies

# drama_comedy_movies=[m.get("title") for m in movies if "Drama" in m.get("genres") and "Comedy" in m.get("genres")]
# print(drama_comedy_movies)                                                                                                                                        
...
#     genre=m.get("genres")
#     for mg in genre:
#         if mg in genre_count:
#             genre_count[mg]+=1
#         else:
#             genre_count[mg]=1
# # print(genre_count)

# gc=[(v,k) for k,v in genre_count.items()]
# print(max(gc))
